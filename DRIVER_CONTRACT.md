...
| `rethinkdb` | `hakobackend-db-rethinkdb` | ✅ live-verified vs 2.4.3 (conformance + index suites; see RETHINKDB_SPIKE.md) | changefeed push (dedicated session per table) | emulated (validate+apply+rollback; see driver notes) |
